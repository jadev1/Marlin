...
#define STRING_CONFIG_H_AUTHOR "(vic10us, d3d config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "X5SA_SKRPRO"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // 27.11.2022 jal Added old Tronxy measurements
    #define DEFAULT_Kp 15.50
    #define DEFAULT_Ki 0.91
    #define DEFAULT_Kd 66.35
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // 27.11.2022 jal Added old Tronxy measurements
  #define DEFAULT_bedKp 236.86
  #define DEFAULT_bedKi 46.26
  #define DEFAULT_bedKd 808.47
...
// Default war 95
// BMG Extruder 415
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 1729 }
